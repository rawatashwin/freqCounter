...
lcd_send_cmd:	; Sends word in lcd_data to lcd
    ...
    ; Send EN
    lcd_send_EN    
    ; Shift out remaining bits (lower)
    lcd_shift_out
    lcd_shift_out
    lcd_shift_out
    lcd_shift_out
...
lcd_send_data:	; Sends word in lcd_data to lcd
    ...
    lcd_send_0
    lcd_send_0
    ; Send 0 for selecting lcd data register
    lcd_send_1
    ; Send EN
    lcd_send_EN    
    ; Shift out remaining bits (lower)
...
wait_1ms:
    ; Assuming 1 nop takes 200ns at 1Mhz Instruction cycle
    nop
    nop
    nop
    nop
...
; Actual delay = 0.04 seconds = 10000 cycles
; Error = 0 %
